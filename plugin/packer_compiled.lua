...
_G.packer_plugins = {
  ...
  ["codeium.vim"] = {
    loaded = true,
    path = "/home/douglasjordan/.local/share/nvim/site/pack/packer/start/codeium.vim",
  ...
  ["lspkind-nvim"] = {
    loaded = true,
    path = "/home/douglasjordan/.local/share/nvim/site/pack/packer/start/lspkind-nvim",
  ...
  nvim = {
    loaded = true,
    path = "/home/douglasjordan/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/douglasjordan/.local/share/nvim/site/pack/packer/start/nvim-lspinstall",
